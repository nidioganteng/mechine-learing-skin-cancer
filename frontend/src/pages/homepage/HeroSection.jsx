...
export default function HeroSection() {
  ...
  return (
    <div className="bg-white overflow-x-hidden font-['Poppins']">
      ...
      {/* Header */}
      <header className="px-[8%] h-12.5 mt-5 flex items-center justify-between">
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            width: '45%', height: '75%',
            borderTopLeftRadius: '800px', borderBottomLeftRadius: '800px',
          }}
        />
        <div className="lg:hidden absolute top-0 right-0 w-48 h-48 rounded-full bg-[#BACED9] opacity-40 -translate-y-1/4 translate-x-1/4 pointer-events-none" />
